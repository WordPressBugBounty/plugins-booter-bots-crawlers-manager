...
<section id="booter-options" class="wrap booter-options">
    ...
    <header class="options-header">
        ...
        <div class="options-title">
            <h1><?php esc_html_e( 'Booter - Bots & Crawlers Manager', 'booter-bots-crawlers-manager' ); ?></h1>
            <p><?php esc_html_e( 'The easy way to correctly manage crawlers and bots.', 'booter-bots-crawlers-manager' ); ?></p>
        </div>
    </header>
    ...
    <form method="post" action="options.php">
        ...
        <input type="hidden" name="booter_settings[updated_at]" value="<?php echo esc_attr( time() ); ?>">
        ...
        <ul class="nav-tab-wrapper" role="tablist">
            <li role="presentation">
                <a href="#booter-general" role="tab" id="booter-general-tab" aria-controls="booter-general" class="nav-tab js-booter-tab nav-tab-active" aria-selected="true">
                    <?php esc_html_e( 'General', 'booter-bots-crawlers-manager' ); ?>
                </a>
            </li>
            <li role="presentation">
                <a href="#booter-bad-bots" role="tab" id="booter-bad-bots-tab" aria-controls="booter-bad-bots" class="nav-tab js-booter-tab" aria-selected="false">
	                <?php esc_html_e( 'Bad Bots Blocking', 'booter-bots-crawlers-manager' ); ?>
                    <span class="js-bad-bots-tab badge" hidden><?php esc_html_e( 'Off', 'booter-bots-crawlers-manager' ); ?></span>
                </a>
            </li>
            <li role="presentation">
                <a href="#booter-robots" role="tab" id="booter-robots-tab" aria-controls="booter-robots" class="nav-tab js-booter-tab">
                    <?php esc_html_e( 'Robots.txt', 'booter-bots-crawlers-manager' ); ?>
                    <span class="js-robots-tab badge" hidden><?php esc_html_e( 'Off', 'booter-bots-crawlers-manager' ); ?></span>
                </a>
            </li>
            <li role="presentation">
                <a href="#booter-ratelimit" role="tab" id="booter-ratelimit-tab" aria-controls="booter-ratelimit" class="nav-tab js-booter-tab">
                    <?php esc_html_e( 'Rate Limit', 'booter-bots-crawlers-manager' ); ?>
                    <span class="js-rate-tab badge" hidden><?php esc_html_e( 'Off', 'booter-bots-crawlers-manager' ); ?></span>
                </a>
            </li>
            <li role="presentation">
                <a href="#booter-reject" role="tab" id="booter-reject-tab" aria-controls="booter-reject" class="nav-tab js-booter-tab">
                    <?php esc_html_e( 'Reject Links', 'booter-bots-crawlers-manager' ); ?>
                    <span class="js-block-tab badge" hidden><?php esc_html_e( 'Off', 'booter-bots-crawlers-manager' ); ?></span>
                </a>
            </li>
            <li role="presentation">
                <a href="#booter-404log" role="tab" id="booter-404log-tab" aria-controls="booter-404log" class="nav-tab js-booter-tab">
                    <?php esc_html_e( '404 Errors Log', 'booter-bots-crawlers-manager' ); ?>
                    <span class="js-404-tab badge" hidden><?php esc_html_e( 'Off', 'booter-bots-crawlers-manager' ); ?></span>
                </a>
            </li>
            <li role="presentation">
                <a href="#booter-disavow" role="tab" id="booter-disavow-tab" aria-controls="booter-disavow" class="nav-tab js-booter-tab">
			        <?php esc_html_e( 'Disavow Backlinks', 'booter-bots-crawlers-manager' ); ?>
                </a>
            </li>
            <li role="presentation">
                <a href="#booter-help" role="tab" id="booter-help-tab" aria-controls="booter-help" class="nav-tab js-booter-tab">
			        <?php esc_html_e( 'Help', 'booter-bots-crawlers-manager' ); ?>
                </a>
            </li>
            <li role="presentation">
                <a href="#booter-about" role="tab" id="booter-about-tab" aria-controls="booter-about" class="nav-tab js-booter-tab">
                    <?php esc_html_e( 'About', 'booter-bots-crawlers-manager' ); ?>
                </a>
            </li>
            ...
            <?php if ( isset( $settings['debug'] ) && \Upress\Booter\Utilities::bool_value( $settings['debug'] ) ) : ?>
                <li role="presentation">
                    <a href="#booter-debug" role="tab" id="booter-debug-tab" aria-controls="booter-debug" class="nav-tab js-booter-tab">
                        <?php esc_html_e( 'Debug', 'booter-bots-crawlers-manager' ); ?>
                    </a>
                </li>
            <?php endif; ?>
        </ul>
